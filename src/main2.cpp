...
int main() {
  ...
  // "Bricks Breaker", sf::Style::Default);
  window.create(sf::VideoMode(screenWidth, screenHeight), "Bricks Breaker",
                sf::Style::Default);
  ...
  paddle.setPosition(
      sf::Vector2f{(screenWidth / 2.f) - (paddle.getSize().x / 2),
                   screenHeight - (10.f + paddle.getSize().y)});
